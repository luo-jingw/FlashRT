...
def test_denoise_loop_runs_and_advances_latent():
    ...
    for L in range(num_double):
        ...
        weights[("action_dit", "double", L, "qkv.weight")] = _fp16(3 * action_attn_width, action_hidden_dim)
        weights[("action_dit", "double", L, "proj.weight")] = _fp16(action_hidden_dim, action_attn_width)
        weights[("action_dit", "double", L, "mlp0.weight")] = _fp16(action_mlp_hidden * 2, action_hidden_dim)
        weights[("action_dit", "double", L, "mlp2.weight")] = _fp16(action_hidden_dim, action_mlp_hidden)
    ...
    for L in range(num_single):
        ...
        weights[("action_dit", "single", L, "qkv.weight")] = _fp16(3 * action_attn_width, action_hidden_dim)
        weights[("action_dit", "single", L, "mlp_in.weight")] = _fp16(action_mlp_hidden * 2, action_hidden_dim)
        weights[("action_dit", "single", L, "attn_out_proj.weight")] = _fp16(action_hidden_dim, action_attn_width)
        weights[("action_dit", "single", L, "mlp_down.weight")] = _fp16(action_hidden_dim, action_mlp_hidden)

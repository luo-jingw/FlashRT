...
PRECISION_COLUMNS = ("fp16", "fp16_cutlass", "fp8", "nvfp4", "fp8_static", "fp8_static_cutlass")
ABSENT = "-"

EXPECTED_ROUTING: dict[tuple[str, str, str], tuple[str, ...]] = {
    # (site, block, slot)                                fp16       fp16_cutlass  fp8       nvfp4     fp8_static  fp8_static_cutlass
    ("backbone", "double", "txt_in.weight"):            ("bf16out", "bf16out",   "bf16out", "bf16out", "bf16out", "bf16out"),
    ("backbone", "double", "img_in.weight"):            ("bf16out", "bf16out",   "bf16out", "bf16out", "bf16out", "bf16out"),
    ("backbone", "double", "txt_qkv.weight"):           ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "img_qkv.weight"):           ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "txt_proj.weight"):          ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "img_proj.weight"):          ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "txt_mlp0.weight"):          ("f16",     "swiglu16",  "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "img_mlp0.weight"):          ("f16",     "swiglu16",  "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "txt_mlp2.weight"):          ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "img_mlp2.weight"):          ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "double", "txt_query_norm"):           ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("backbone", "double", "txt_key_norm"):             ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("backbone", "double", "img_query_norm"):           ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("backbone", "double", "img_key_norm"):             ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("backbone", "single", "linear1.weight"):           ("f16",     ABSENT,      "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "single", "qkv.weight"):               (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("backbone", "single", "mlp_in.weight"):            (ABSENT,    "swiglu16",  ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("backbone", "single", "linear2.weight"):           ("f16",     ABSENT,      "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "single", "attn_out_proj.weight"):     (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("backbone", "single", "mlp_down.weight"):          (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("backbone", "single", "query_norm"):               ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("backbone", "single", "key_norm"):                 ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("action_dit", "shared", "action_encoder.weight"):  ("f16",     "f16",       "f16",     "f16",     "f16",     "f16"),
    ("action_dit", "shared", "action_encoder.bias"):    ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("action_dit", "shared", "head.linear.weight"):     ("f16",     "f16",       "f16",     "f16",     "f16",     "f16"),
    ("action_dit", "double", "qkv.weight"):             ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "double", "proj.weight"):            ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "double", "mlp0.weight"):            ("f16",     "swiglu16",  "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "double", "mlp2.weight"):            ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "double", "query_norm"):             ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("action_dit", "double", "key_norm"):               ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("action_dit", "single", "linear1.weight"):         ("f16",     ABSENT,      "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "single", "qkv.weight"):             (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("action_dit", "single", "mlp_in.weight"):          (ABSENT,    "swiglu16",  ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("action_dit", "single", "linear2.weight"):         ("f16",     ABSENT,      "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "single", "attn_out_proj.weight"):   (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("action_dit", "single", "mlp_down.weight"):        (ABSENT,    "cutlass16", ABSENT,    ABSENT,    ABSENT,    ABSENT),
    ("action_dit", "single", "query_norm"):             ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
    ("action_dit", "single", "key_norm"):               ("ptr",     "ptr",       "ptr",     "ptr",     "ptr",     "ptr"),
}

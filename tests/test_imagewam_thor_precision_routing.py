...
EXPECTED_ROUTING: dict[tuple[str, str, str], tuple[str, ...]] = {
    ...
    ("backbone", "single", "attn_out_proj.weight"):     ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("backbone", "single", "mlp_down.weight"):          ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ...
    ("action_dit", "single", "attn_out_proj.weight"):   ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),
    ("action_dit", "single", "mlp_down.weight"):        ("f16",     "cutlass16", "fp8",     "nvfp4",   "sfp8",    "sfp8c"),

...
Untested here for the same Blackwell-only reason as the rest of this
script; the VAE itself is plain PyTorch/cuDNN and has no such
restriction, so it should run on Thor regardless of whether the FP4
GEMM path below it does.
"""
...
class FullImageWAMFP4:
    ...
    def __init__(self):
        ...
        self.img_in = _Fp4Linear(HIDDEN, VAE_PATCH_TOKEN_DIM)
...
def main():
    ...
    print(f"backbone_prefill_fp4 (25L + VAE)    P50={p50:8.3f} ms  P90={p90:8.3f} ms  mean={mean:8.3f} ms")

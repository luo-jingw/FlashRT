...
python -m pytest tests/test_imagewam_text_trim_consumer_guards.py -q 2>&1 | tee $OUT/S4p_guards.log   # 期望 14 passed（上一轮 11；该文件本轮新增 2 条 CPU 行与 1 条口径 pin）。这个文件不读 IMAGEWAM_NATIVE_PRECISION，它的前端固定 fp16
